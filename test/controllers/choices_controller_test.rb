...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference("Choice.count") do
      post choices_url, params: { choice: { option_text: @choice.option_text, poll_id: @choice.poll_id } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { option_text: @choice.option_text, poll_id: @choice.poll_id } }
